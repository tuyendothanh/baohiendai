...
import com.manuelmaly.hn.server.CategoryChildDownloadCommand;
...
public abstract class CategoryChildBaseTask extends BaseTask<HNFeed> {

    public CategoryChildBaseTask(String notificationBroadcastIntentID, int taskCode) {
    ...
    class HNFeedTaskRunnable extends CancelableRunnable {
        ...
        CategoryChildDownloadCommand mFeedDownload;

        @Override
        public void run() {
            mFeedDownload = new CategoryChildDownloadCommand(getFeedURL(), getCatId(), getCurrentPage(), new HashMap<String, String>(), RequestType.GET, false, null,
